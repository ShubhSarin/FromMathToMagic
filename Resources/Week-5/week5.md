...
> [!NOTE]
> **Optional Deep Dive:** Don't read about DDPMs, UNets, or diffusion yet (Weeks 7-10). Don't read the original VAE paper. Don't read about GANs or StyleGAN — different architecture, different project. Focus on training your VAE and getting good face reconstructions.
